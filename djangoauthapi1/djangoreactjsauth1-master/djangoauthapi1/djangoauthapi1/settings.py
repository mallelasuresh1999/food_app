...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'loginregreactjsmui1/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'USER': 'admin',
        'PASSWORD':'12345678',
        'HOST':'mysqldb.c29hxdurne9l.ap-south-1.rds.amazonaws.com',
        'PORT':'3306',
    }
}
...
STATICFILES_DIRS=[os.path.join(BASE_DIR,"static_cdn"),os.path.join(BASE_DIR,'build','static'),]
